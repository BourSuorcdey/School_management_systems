...
@section('content')
    <x-forms.post :action="route('admin.student.update', $student)">
        @csrf
        <x-backend.card>
            <x-slot name="header">
                @lang('Update Student')
            ...
            <x-slot name="body">
                <div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="name" class="form-control" placeholder="{{ __('Name') }}" value="{{ old('name') ?? $student->name }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="number" name="age" class="form-control" placeholder="{{ __('Age') }}" value="{{ old('age') ?? $student->age }}" maxlength="100" required />
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="email" name="email" id="email" class="form-control" placeholder="{{ __('E-mail Address') }}" value="{{ old('email') ?? $student->email }}" maxlength="255" required />
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row">
